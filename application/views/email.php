<link href="<?php echo base_url();?>public2/assets/css/lib/themify-icons.css" rel="stylesheet">
    <link href="<?php echo base_url();?>public2/assets/css/lib/font-awesome.min.css" rel="stylesheet">
    <link href="<?php echo base_url();?>public2/assets/css/lib/menubar/sidebar.css" rel="stylesheet">
    <link href="<?php echo base_url();?>public2/assets/css/lib/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo base_url();?>public2/assets/css/lib/Unix.css" rel="stylesheet">
    <link href="<?php echo base_url();?>public2/assets/css/style.css" rel="stylesheet">
...
<div class="content-wrap">
                                            ...
                                            <aside class="sm-side">
                                                <div class="user-head">
                                                    <a class="inbox-avatar" href="javascript:;">
                                                        <img src="<?php echo base_url();?>public2/assets/images/user.jpg" alt="">
                                                    </a>
                                                    <div class="user-name">
    ...
    <script src="<?php echo base_url();?>public2/assets/js/lib/jquery.min.js"></script>
    <script src="<?php echo base_url();?>public2/assets/js/lib/jquery.nanoscroller.min.js"></script>
    <script src="<?php echo base_url();?>public2/assets/js/lib/jquery.nicescroll.min.js"></script>
    <script src="<?php echo base_url();?>public2/assets/js/lib/menubar/sidebar.js"></script>
    <script src="<?php echo base_url();?>public2/assets/js/lib/preloader/pace.min.js"></script>
    <script src="<?php echo base_url();?>public2/assets/js/lib/bootstrap.min.js"></script>


    <script src="<?php echo base_url();?>public2/assets/js/scripts.js"></script>