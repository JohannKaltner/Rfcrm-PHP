 				...
 				<div class="col-lsm-6">
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
 						...
 						<div class="form-group">
 							<label for="street" class=" form-control-label">Bairro</label>
 							<input type="text" id="street" placeholder="Insira o Bairro do Cliente" class="form-control">
 						</div>
                         <div class="form-group">
                             <label for="country" class=" form-control-label">Cep</label>
                             <input type="text" id="country" placeholder="Insira o Cep do Cliente" class="form-control">
                         </div>
 						<div class="row form-group">
 							<div class="col-8">
 								<div class="form-group">
 									<label for="city" class=" form-control-label">Cidade</label>
 									<input type="text" id="city" placeholder="Insira a Cidade do Cliente" class="form-control">
 								</div>
 							</div>
 							<div class="col-8">
 								<div class="form-group">
