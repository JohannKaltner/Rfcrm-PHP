...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/css/perfil-css.css"/> 
<div id="profile2">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-3 center">
							<span class="profile-picture">
								<img class="editable img-responsive" alt=" Avatar" id="avatar2" src="<?php echo base_url(); ?>public/images/perfil/<?php echo $this->session->userdata('usuario_nome'); ?>.jpg">
							</span>
							...
							<a href="#" class="btn btn-sm btn-block btn-primary">
								...
								<span class="bigger-110">Enviar Mensagem</span>
							</a>
						</div><!-- /.col -->

						<div class="col-xs-12 col-sm-9">
							<h4 class="blue">
                            <i class="fas fa-inbox"></i> <span class="email"><?php echo $this->session->userdata('usuario_nome'); ?> </span>
 <br>
							...
							<div class="profile-user-info">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span><?php echo $this->session->userdata('usuario_data_inicio'); ?></span>
									</div>
								</div>
