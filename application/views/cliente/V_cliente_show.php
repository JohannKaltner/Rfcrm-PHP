                                ...
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                            ...
                                            aria-selected="false" style="color:#2C0CB8;">CHAMADOS & CORREÇÕES</a>

                                        <a class="nav-item nav-link" id="nav-contato-tab" data-toggle="tab"
                                            href="#nav-contato" role="tab" aria-controls="nav-contato"
                                            aria-selected="false" style="color:#2C0CB8;">CONTATOS</a>
                                ...
                                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        ...
                                        <div>
                                            ...
                                            <form method='post'
                                                action="<?php echo site_url('C_cliente/exibir') ?>/<?php echo $linha['0']->cliente_id; ?>">

                                                <!-- INFORMAÇÕES TECNICAS -->
                                                <h4 style="padding-bottom:10px;"> ● Informações Avançadas <small>
                                                        Somente membros com permissão</small></h4>
                                                ...
                                                <div class="form-group">
                                                    <label for="cliente_id" class=" form-control-label">NUMERO DO
                                                        ID</label>
                                                ...
                                                <div class="form-group">
                                                    <label for="cliente_id" class=" form-control-label">Codigo do
                                                        Cliente</label>
                                                    <input type="text" id="cliente_id"
                                                        value="<?php echo $linha['0']->cod_cliente; ?>"
                                                        name="cod_cliente" placeholder="NULO" class="form-control"
                                                        disabled="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="cliente_cpf"
                                                        value="<?php echo $linha['0']->cliente_cpf; ?>"
                                                        name="cliente_cpf" placeholder="Insira o CNPJ do Cliente"
                                                        class="form-control" disabled="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="cpf/cnpj" class=" form-control-label">CNPJ</label>
                                                    <input type="text" id="cliente_cnpj"
                                                        value="<?php echo $linha['0']->cliente_cnpj; ?>"
                                                        name="cliente_cnpj" placeholder="Insira o CNPJ do Cliente"
                                                        class="form-control" disabled="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="company"
                                                        value="<?php echo $linha['0']->cliente_nome; ?>"
                                            ...
                                            <div class='row'>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <button type="button" class="btn btn-primary"
                                                                    data-toggle="modal" data-target="#contatoModal"
                                                                    style="  font-size:18px;">Novo Contato
                                                                </button>
                                                                <hr>
                                                                <?php
                                                if (isset($contatos) && !empty($contatos)) {
                                                   foreach ($contatos as $contato) { ?>
                                                                <tr>
                                                                    <td><?php echo $contato->contato_secundario_id; ?>
                                                                    </td>
                                                                    <td><?php echo $contato->contato_secundario_nome; ?>
                                                                    </td>
                                                                    <td><?php echo $contato->contato_secundario_telefone; ?>
                                                                    </td>
                                                                    <td><?php echo $contato->contato_secundario_email; ?>
                                                                    </td>
                                                                    <td><?php echo $contato->contato_secundario_funcao; ?>
                                                                    </td>
                                                                    <td>
                                                                        <div>
                                                                            <button style="padding:0px 10px 0 0"
                                                                                data-toggle="modal"
                                                                                data-target="#contatoEditModal"
                                                                                type="button"><i
                                                                                    class="zmdi zmdi-edit"></i>
                                                                            </button>
                                                                            <a
                                                                                href="<?php echo base_url('C_cliente/deletaContato') ?>/<?php echo $contato->contato_secundario_id; ?>">
                                                                                <button><i class="zmdi zmdi-delete"></i>
                                                                                </button></a>
                                                                            <a style="padding:0px 0px 0 10px;"
                                                                                href="https://api.whatsapp.com/send?phone=55<?php echo $contato->contato_secundario_telefone; ?>">
                                                                                <button><i class="fab fa-whatsapp"></i>
                                                                                </button></a>
                                            ...
                                            <nav>
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <a class="nav-item nav-link active" id="nav-home-tab"
                                                        data-toggle="tab" href="#tab_chamados" role="tab"
                                                        aria-controls="tab_chamados" aria-selected="true">Chamados</a>
                                                    <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab"
                                            ...
                                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade show active" id="tab_chamados" role="tabpanel"
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                                        data-target="#exampleModal" style="font-size:18px;">Abrir
                                                        Chamado
                                                    </button>
                                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="home-tab" data-toggle="tab"
                                                                href="#email" role="tab" aria-controls="home"
                                                                aria-selected="true">E-mail</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="profile-tab" data-toggle="tab"
                                                                href="#ligacao" role="tab" aria-controls="profile"
                                                                aria-selected="false">Ligação</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" id="profile-tab" data-toggle="tab"
                                                                href="#nulo" role="tab" aria-controls="profile"
                                                                aria-selected="false">Todos</a>
                                                        </li>
                                                    </ul>
                                                    ...
                                                    <div class="tab-content pl-3 p-1" id="myTabContent">
                                                        ...
                                                        <div class="tab-pane fade show active" id="email"
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                     <?php if (!empty($chamadosEmail)) {
																		  foreach ($chamadosEmail as $chamadosEmail) { ?>
                                                                    <div class="col-md-6">
                                                                        <div class="card"
                                                                            href="<?php echo base_url(); ?>C_cliente/exibir/<?php echo $chamadosEmail->chamado_id; ?>"
                                                                            id="listgroup"
                                                                            style="position: relative!important;">

                                                                            <div class="card-header">
                                                                                <strong class="card-title"><i style="color:#007bff" class="fas fa-at"></i>&nbsp;<?php echo $chamadosEmail->chamado_meio;?>&nbsp;&nbsp;<br> <?php echo $chamadosEmail->chamado_atendente_cliente; ?>
                                                                                    as
                                                                                    <?php echo$chamadosEmail->chamado_data; ?>
																			
                                                                                    <small>
                                                                                        <span
                                                                                            class="badge badge-primary float-right mt-1">Chamado
                                                                                            de
                                                                                            ID:<?php echo $chamadosEmail->chamado_id; ?></span>
                                                                                    </small>
                                                                                </strong>
                                                                            </div>
                                                                            <div id="card" class="card-body">
                                                                                <p class="card-text">
                                                                                    <h5 onHover
                                                                                        ...
                                                                                        onMouseOut="this.style.color='#000000'"
                                                                                        id="chamadogroup" class="mb-1">
                                                                                        <?php echo $chamadosEmail->chamado_atendente_cliente; ?>,<br>
                                                                                        <small class="mb-1">Em
                                                                                            nome
                                                                                            da(o)</small>
                                                                                        <?php echo $chamadosEmail->cliente_nome; ?>,
                                                                                        <small class="mb-1"> Dia
                                                                                            <b style="color:black">
                                                                                                <?php echo $chamadosEmail->chamado_data; ?>,
                                                                                            </b> as
                                                                                            <b
                                                                                                style="color:black"><?php echo $chamadosEmail->chamado_hora; ?></b></small><br>
                                                                                    </h5>
                                                                                </p>
                                                                                <div id="no-display">
                                                                                    <p class="mb-1">Entrou em
                                                                                        contato
                                                                                        com
                                                                                        <b
                                                                                            style="color:black"><?php echo $chamadosEmail->chamado_atendente_rf; ?></b>
                                                                                        para <b
                                                                                            style="color:black"><?php echo $chamadosEmail->chamado_atividade; ?></b>em
                                                                                        relação a
                                                                                        <b style="color:black">
                                                                                            <?php echo $chamadosEmail->chamado_assunto; ?></b>,
                                                                                        o chamado
                                                                                        realizado pelo numero
                                                                                        <b><?php echo $chamadosEmail->chamado_telefone; ?></b>,
                                                                                        teve duração de <small>
                                                                                            <b
                                                                                                style="color:black"><?php echo $chamadosEmail->chamado_duracao_hora; ?></b>
                                                                                            Hora e <b
                                                                                                style="color:black"><?php echo $chamadosEmail->chamado_duracao_minuto; ?></b>
                                                                                            Minutos.</small>
                                                                                    </p>
                                                                                    <hr>
                                                                                    <br>
                                                                                    Observações:<br><b
                                                                                        style="color:black"><?php echo $chamadosEmail->chamado_obs; ?></b><br>
                                                                                    <hr>
                                                                                    <button data-toggle="modal"
                                                                                        data-target="#correcaoModal"
                                                                                        onMouseOver="this.style.color='#007bff'"
                                                                                        onMouseOut="this.style.color='#000000'">
                                                        ...
                                                        <div class="tab-pane fade" id="ligacao" role="tabpanel"
                                                            aria-labelledby="profile-tab">
                                                            <div class="col-lg-12">
                                                                <div class="row">
                                                                    <?php if (!empty($chamadosLigacao)) {
                                               					    foreach ($chamadosLigacao as $chamadosLigacao) { ?>
                                                                    <div class="col-md-6">
                                                                        <div class="card"
                                                                            href="<?php echo base_url(); ?>C_cliente/exibir/<?php echo $chamadosLigacao->chamado_id; ?>"
                                                                            id="listgroup"
                                                                            style="position: relative!important;">
                                                                            <div class="card-header">
																			<strong class="card-title">
																			<i style="color:#1fb541" class="fas fa-phone"></i>&nbsp;<?php echo $chamadosLigacao->chamado_meio;?>&nbsp;&nbsp;<br>
																			<?php echo $chamadosLigacao->chamado_atendente_cliente; ?>
                                                                                    as
                                                                                    <?php echo $chamadosLigacao->chamado_data; ?>
                                                                                    <small>
                                                                                        <span
                                                                                            class="badge badge-primary float-right mt-1">Chamado
                                                                                            de
                                                                                            ID:<?php echo $chamadosLigacao->chamado_id; ?></span>
                                                                                    </small>
                                                                                </strong>
                                                                            </div>
                                                                            <div id="card" class="card-body">
                                                                                <p class="card-text">
                                                                                    <h5 onHover
                                                                                        ...
                                                                                        onMouseOut="this.style.color='#000000'"
                                                                                        id="chamadogroup" class="mb-1">
                                                                                        <?php echo $chamadosLigacao->chamado_atendente_cliente; ?>,<br>
                                                                                        <small class="mb-1">Em
                                                                                            nome
                                                                                            da(o)</small>
                                                                                        <?php echo $chamadosLigacao->cliente_nome; ?>,
                                                                                        <small class="mb-1"> Dia
                                                                                            <b style="color:black">
                                                                                                <?php echo $chamadosLigacao->chamado_data; ?>,
                                                                                            </b> as
                                                                                            <b
                                                                                                style="color:black"><?php echo $chamadosLigacao->chamado_hora; ?></b></small><br>
                                                                                    </h5>
                                                                                </p>
                                                                                <div id="no-display">
                                                                                    <p class="mb-1">Entrou em
                                                                                        ...
                                                                                        com
                                                                                        <b
                                                                                            style="color:black"><?php echo $chamadosLigacao->chamado_atendente_rf; ?></b>
                                                                                        para <b
                                                                                            style="color:black"><?php echo $chamadosLigacao->chamado_atividade; ?></b>em
                                                                                        relação a
                                                                                        <b style="color:black">
                                                                                            <?php echo $chamadosLigacao->chamado_assunto; ?></b>,
                                                                                        o chamado
                                                                                        realizado pelo numero
                                                                                        <b><?php echo $chamadosLigacao->chamado_telefone; ?></b>,
                                                                                        teve duração de <small>
                                                                                            <b
                                                                                                style="color:black"><?php echo $chamadosLigacao->chamado_duracao_hora; ?></b>
                                                                                            Hora e <b
                                                                                                style="color:black"><?php echo $chamadosLigacao->chamado_duracao_minuto; ?></b>
                                                                                            Minutos.</small>
                                                                                    </p>
                                                                                    <hr>
                                                                                    <br>
                                                                                    Observações:<br><b
                                                                                        style="color:black"><?php echo $chamadosLigacao->chamado_obs; ?></b><br>
                                                                                    <hr>
                                                                                    <button data-toggle="modal"
                                                                                        data-target="#correcaoModal"
                                                                                        onMouseOver="this.style.color='#007bff'"
                                                        ...
                                                        <div class="tab-pane fade" id="nulo" role="tabpanel"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="card"
                                                                            ...
                                                                            <div class="card-header">
                                                                                <strong
                                                                                    class="card-title">
																					<i style="color:red;" class="fas fa-exclamation"></i>&nbsp;<?php echo $chamado->chamado_meio;?>&nbsp;&nbsp;<br>
																					<?php echo $chamado->chamado_atendente_cliente; ?>
                                                                                    as
                                                                                    <?php echo $chamado->chamado_data; ?>
                                                                                    <small>
                                                                                        <span
                                                                                            class="badge badge-primary float-right mt-1">Chamado
                                                                                            de
                                                                                            ID:<?php echo $chamado->chamado_id; ?></span>
                                                                                    </small>
                                                                                </strong>
                                                                            </div>
                                                                            <div id="card" class="card-body">
                                                                                ...
                                                                                <div id="no-display">
                                                                                    <p class="mb-1">Entrou em
                                                                                        ...
                                                                                        relação a
                                                                                        <b style="color:black">
                                                                                            <?php echo $chamado->chamado_assunto; ?></b>,
                                                                                        o chamado
                                                                                        realizado pelo numero
                                                	...
                                                	foreach ($correcoes as $correcao) { ?>
                                                            <div class="col-md-6">
                                                                <div class="card"
                                                                    ...
                                                                    style="position: relative!important;">
                                                                    <div class="card-header">
                                                                        <strong class="card-title">Corrigindo o
                                                                            Chamado
                                                                            <small>
                                                                                <span
                                                                                    class="badge badge-danger float-right mt-1">Corrigindo
                                                                                    o Chamado de ID:
                                                                    ...
                                                                    <div id="card" class="card-body">
                                                                        <p class="card-text">
                                                                            <h5 onHover
                                                                                ...
                                                                                <small class="mb-1">Em nome
                                                                                    da(o)</small>
                                                                                <?php echo $correcao->correcao_nome_cliente; ?>,
                                                                                <small class="mb-1"> Dia <b
                                                                                        style="color:black">
                                                                                        <?php echo $correcao->correcao_data; ?>,
                                                                                    </b> as
                                                                                    <b
                                                                        ...
                                                                        <div id="no-display">
                                                                            <p class="mb-1">Entrou em contato
                                                                                com
                                                                                <b
                                                                                ...
                                                                                relação a
                                                                                <b style="color:black">
                                                                                    <?php echo $correcao->correcao_assunto; ?></b>,
                                                                                o chamado
                                                                                realizado pelo numero
                        ...
                        <div class="row form-group" style="display:none;">
                            <div class="col col-md-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="chamado_id_cliente"
                                        value="<?php echo $linha['0']->cliente_id; ?>" name="chamado_id_cliente"
                            ...
                            <div class="col col-md-12">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="chamado_id_usuario"
                                        value="<?php echo $this->session->userdata('usuario_id'); ?>"
                                        name="chamado_id_usuario" placeholder="Id do Cliente" class="form-control">
                                </div>
            ...
            <div class="card-body">
                ...
                <form method='post'
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="cod_cliente" value="<?php echo $linha[0]->cod_cliente; ?>"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="company" value="<?php echo $linha[0]->cliente_nome;?>"
                            name="cliente_nome" placeholder="Insira o nome do Cliente" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="cpf/cnpj" class=" form-control-label">CPF</label>
                    ...
                    <div class="form-group">
                        <label for="bairro" class=" form-control-label">Bairro</label>
                        <input type="text" id="street" name="cliente_bairro"
                            value="<?php echo $linha[0]->cliente_bairro; ?>" placeholder="Insira o Bairro do Cliente"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="cep" class=" form-control-label">Cep</label>
                        <input type="text" id="cliente_cep" name="cliente_cep"
                            value="<?php echo $linha[0]->cliente_cep; ?>" placeholder="Insira o Cep do Cliente"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="cidade" class=" form-control-label">Cidade</label>
                        <input type="text" id="city" name="cliente_cidade"
                            value="<?php echo $linha[0]->cliente_cidade; ?>" placeholder="Insira a Cidade do Cliente"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="estado" class=" form-control-label">Estado</label>
                    ...
                    <div class="form-group">
                        <label for="postal-code" class=" form-control-label">País</label>
                        <input type="text" id="postal-code" name="cliente_pais"
                            value="<?php echo $linha[0]->cliente_pais; ?>" placeholder="Insira o País do Cliente"
                            class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="postal-code" class=" form-control-label">Insc.
...
<div class="modal fade" id="correcaoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method='post' action="<?php echo base_url('C_cliente/criarCorrecao/'); ?>"
                    class="form-horizontal">
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <div class="input-group">
                                ...
                                <input value="<?php echo $linha['0']->cliente_id; ?>" type="text"
                                    id="correcao_id_cliente" name="correcao_id_cliente" placeholder="Id do Cliente"
                                    class="form-control">
                            </div>
                            <small>Qual o ID do cliente? </small>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="chamado_atividade" name="correcao_atividade"
                    ...
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="chamado_atendente_rf"
                                    value="<?php echo $this->session->userdata('usuario_nome'); ?>"
                                    name="correcao_atendente_rf" placeholder="Quem atendeu ao chamado?"
                                    class="form-control">
                            </div>
                            <small> Quem da RF&A atendeu? </small>
                        </div>
                    ...
                    <div class="row form-group">
                        <div class="col col-md-12">
                            <div class="input-group">
                                ...
                                <input type="text" id="chamado_telefone" name="correcao_telefone"
                ...
                <form method='post' action="<?php echo base_url('C_cliente/criarContato/'); ?>" class="horizontal-form">
                    ...
                    <div class="form-group" style="display:none">
                        <div class="input-group">
                            ...
                            <input value="<?php echo $this->session->userdata('usuario_id'); ?>" type="text"
                                id="username" name="contato_id_usuario" placeholder="Id do usuario"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
