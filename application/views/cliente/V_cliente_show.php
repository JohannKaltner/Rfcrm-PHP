			...
			<div class="card-body">
				...
				<form method='post' action="<?php echo base_url('C_Cliente/update/'); ?>" class="form-horizontal">
					...
					<div class="form-group">
						<label for="postal-code" class=" form-control-label">Nome</label>
						<small style="color:red"> Opcional</small>
						<input name="cliente_contatos" type="text" id="postal-code" value="<?php echo $linha->cliente_contato_nome; ?>" placeholder="Insira o nome do contato secundario" class="form-control">
					</div>
					<div class="form-group">
						<label for="postal-code" class=" form-control-label">
							Numero</label>
						<input name="cliente_contatos" type="text" id="cliente_contato_telefone" placeholder="Insira o numero do contato secundario" class="form-control">
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
						<button type="submit" value="save" class="btn btn-primary">Save changes</button>
